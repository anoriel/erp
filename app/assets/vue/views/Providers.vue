  ...
  <div>
    ...
    <div class="card border-primary margin5">
      ...
      <div class="card-body text-primary">
        <p class="card-text">
          On this page, you can add / edit / delete providers.
        </p>
      </div>
    </div>
...
export default {
  ...
  computed: {
    ...
    hasError() {
      return this.$store.getters["provider/hasError"];
    },
    error() {
      return this.$store.getters["provider/error"];
    },
    hasProviders() {
      return this.$store.getters["provider/hasProviders"];
    },
    providers() {
  ...
  methods: {
    async createProvider() {
      ...
      const result = await this.$store.dispatch("provider/create", payload);
      if (result !== null) {
